...
let DISCOVERY_COPY = {
    'en-US': {
        ...
        hotspotTrendStrip: {
            ...
            title: 'The Global Edit',
            action: 'View All',
            items: [
                {
                    id: 'copenhagen-minimalist',
        ...
        communityPosts: [
            {
                ...
                tags: ['Minimalist', 'Urban Tailoring', 'SS24'],
                comments: [
                    { author: 'Julian_K', time: '1H AGO', body: 'The silhouette is incredible. It feels like wearing architecture.' },
            ...
            },
            {
                ...
                tags: ['Eveningwear', 'Material Study', 'Drop Notes'],
                comments: [
                    { author: 'Atelier_67', time: '2H AGO', body: 'The construction feels technical without losing softness.' },
        ...
        communityPosts: [
            {
                ...
                tags: ['极简', '都市剪裁', 'SS24'],
                comments: [
                    { author: 'Julian_K', time: '1小时前', body: '这个轮廓太强了，像是在穿建筑。' },
            ...
            },
            {
                ...
                tags: ['晚装', '材质研究', '限量投放'],
                comments: [
                    { author: 'Atelier_67', time: '2小时前', body: '结构非常技术化，但仍保留了柔和度。' },
