...
1.  **Mixed Content (No Space)**:
    -   File: `apps/web-legacy/zh-CN.json`
...
| :--- | :--- | :--- | :--- | :--- |
| `apps/web-legacy/zh-CN.json` | `error_password_length` | `密码至少需要6个字符` | `密码至少需要 6 个字符` | Added space around number |
| `apps/web-legacy/zh-CN.json` | `item_name_101` | `白色T恤` | `白色 T 恤` | Added space around English word |
| `apps/web-legacy/zh-CN.json` | `detecting_location` | `定位中...` | `定位中……` | Replaced with Chinese ellipsis |
| `apps/web-legacy/zh-CN.json` | `location_degraded` | ` (市级精度)` | `（市级精度）` | Replaced with full-width parentheses |
